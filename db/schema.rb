...
ActiveRecord::Schema.define(version: 2020_06_15_233732) do
  ...
  create_table "results", force: :cascade do |t|
    ...
    t.index ["vegetable_id"], name: "index_results_on_vegetable_id"
  end
  ...
  add_foreign_key "results", "carbs"
  add_foreign_key "results", "proteins"
  add_foreign_key "results", "users"
  add_foreign_key "results", "vegetables"
end
